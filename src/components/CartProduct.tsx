...
const CartProduct =({item}:cartProductProps) =>{
    ...
    return (
        <div className="bg-gray-100 rounnded-lg flex items-center gap-4">
            ...
            <div className="flex items-center px-2 gap-4">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-gray-600">Unit Price{" "}<span className="font-semibold text-amazon_blue">
                        <FormattedPrice amount={item.price*100} /></span></p>
                ...
                <div className="text-lg font-semibold text-amazon_blue"><FormattedPrice amount={item.price*100*item.quantity}/></div>
            </div> 
        </div>
    );
}
