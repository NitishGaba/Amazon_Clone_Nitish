...
const Header =() =>{
    ...
    return(
        <div className="w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50">
            ...
            {/*sign in*/}
            {userInfo?<div className="flex items-center px-2 border border-transparent hover:border-white cursor-pointer duration-300 items-center justify-center h-[70%]">
                ...
                <p>Hello, SignIn</p>
                <p className="text-white font-bold flex item-center">Accounts and Lists{""}
                    <span>
                        <BiCaretDown/>
                    </span>
                </p>
